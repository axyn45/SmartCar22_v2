...
/** CCU6中断CPU标号 */
const unsigned char Ccu6IrqVectabNum[2]  = {CCU60_VECTABNUM, CCU61_VECTABNUM};

/** CCU6中断优先级 */
const unsigned char Ccu6IrqPriority[4]   = {CCU60_CH0_PRIORITY, CCU60_CH1_PRIORITY, CCU61_CH0_PRIORITY, CCU61_CH1_PRIORITY};
...
void CCU6_InitConfig(CCU6_t ccu6, CCU6_Channel_t channel, uint32 us)
{
    ...
    unsigned char Index = ccu6 * 2 + channel;
