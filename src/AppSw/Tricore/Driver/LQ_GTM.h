...
#define beep_on   ATOM_PWM_SetDuty(IfxGtm_ATOM2_4_TOUT30_P33_8_OUT,1000, 4000);
#define beep_off   ATOM_PWM_SetDuty(IfxGtm_ATOM2_4_TOUT30_P33_8_OUT,0, 4000);//蜂鸣器开和关
////////////////ATOM_PWM//////////////////////
